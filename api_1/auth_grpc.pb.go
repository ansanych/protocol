...
const (
	Auth_Register_FullMethodName    = "/protocol.Auth/Register"
	Auth_Login_FullMethodName       = "/protocol.Auth/Login"
	Auth_Refresh_FullMethodName     = "/protocol.Auth/Refresh"
	Auth_CheckAccess_FullMethodName = "/protocol.Auth/CheckAccess"
)
...
type AuthClient interface {
	...
	CheckAccess(ctx context.Context, in *AccessRequest, opts ...grpc.CallOption) (*Access, error)
}
...
func (c *authClient) CheckAccess(ctx context.Context, in *AccessRequest, opts ...grpc.CallOption) (*Access, error) {
	out := new(Access)
	err := c.cc.Invoke(ctx, Auth_CheckAccess_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServer interface {
	...
	CheckAccess(context.Context, *AccessRequest) (*Access, error)
...
func (UnimplementedAuthServer) CheckAccess(context.Context, *AccessRequest) (*Access, error) {
...
func _Auth_CheckAccess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_CheckAccess_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).CheckAccess(ctx, req.(*AccessRequest))
	}
	return interceptor(ctx, in, info, handler)
}
